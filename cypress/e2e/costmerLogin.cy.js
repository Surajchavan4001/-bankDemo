...
describe("Home page for user VTC", function () {
  it("verifying details on home page", function () {
    cy.get(".borderM > :nth-child(1) > strong")
      .should("be.visible")
      .should("contain", "Welcome Harry"); //welcome user meassge
    cy.get(".logout")
      .should("be.visible")
      .should("contain", "Logout")
      .should("be.enabled"); // logout button
    cy.get(".home")
      .should("be.visible")
      .should("contain", "Home")
      .should("be.enabled"); // logout button
    cy.get('[ng-class="btnClass1"]')
      ...
      .should("be.enabled"); //transaction button
    cy.get('[ng-class="btnClass2"]')
      .should("be.visible")
      .should("contain", "Deposit")
      .should("be.enabled"); //deposit button
    cy.get('[ng-class="btnClass3"]')
      .should("be.visible")
      .should("contain", "Withdrawl")
      .should("be.enabled"); //Withdrawl button
